...
-- CreateEnum
CREATE TYPE "SubscriptionStatus" AS ENUM ('ACTIVE', 'PENDING', 'EXPIRED', 'CANCELLED', 'PAST_DUE', 'TRIALING');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CASH', 'CARD', 'BANK_TRANSFER', 'ONLINE', 'CHEQUE', 'OTHER');

-- CreateEnum
CREATE TYPE "RuleType" AS ENUM ('REMINDER', 'ALERT', 'NOTIFICATION');

-- CreateEnum
CREATE TYPE "TriggerType" AS ENUM ('BEFORE_RENEWAL', 'ON_RENEWAL', 'AFTER_RENEWAL', 'PAYMENT_DUE', 'PAYMENT_OVERDUE', 'SUBSCRIPTION_EXPIRED', 'INVOICE_CREATED', 'INVOICE_PAID', 'CUSTOM');
